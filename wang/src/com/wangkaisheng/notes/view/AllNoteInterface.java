...
import com.wangkaisheng.notes.controller.lmpl.AllnoteInterfaceImpl;
 ...
 */
public class AllNoteInterface {
    private final JFrame frame = new JFrame("所有笔记");
    private final JButton quaryNote = new JButton("查找笔记");
    private final JButton seeNote = new JButton("查看笔记");
    private final JButton cancelNote = new JButton("删除笔记");
    ...
    private final AllnoteInterface allnoteInterface = new AllnoteInterfaceImpl();
    ...
    private void placeComponents(JPanel panel, AllNote allNote) {
        ...
        panel.add(quaryNote);
        cancelNote.setBounds(250,60,150,25);
    ...
    public AllNoteInterface(User user) {
        final JPanel panel = new JPanel();
        frame.setSize(450, 450);
        frame.setLocationRelativeTo(null);
        AllNote allNote = allnoteInterface.getAllNotes();
        ...
        quaryNote.addActionListener(actionEvent -> {
            ...
            Note note = new Note();
            note.setTitle(name);
            AllNote allNote1 = allnoteInterface.quaryNote(note,allNote);
            if (allNote1 == null) {
        ...
        seeNote.addActionListener(actionEvent -> {
            ...
            if(allnoteInterface.getAllNoteInformation(note)){
        ...
        cancelNote.addActionListener(actionEvent -> {
            ...
            if(allnoteInterface.cancelNote(note)){
